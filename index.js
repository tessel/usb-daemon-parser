...
module.exports.stdoutAck = function(id, ackSize) {
  return createHeader(CMD_ACK_STDOUT, id, 0, ackSize.length);
}

module.exports.stderrAck = function(id, ackSize) {
  return createHeader(CMD_ACK_STDERR, id, 0, ackSize.length);
